...
const regex_name: any = () => { return /^(?=^[a-zA-Z-é]*$)(?=.*[A-Z]+[a-z][A-Z]*)/ } /* Start with one Uppercase, one Lowercase just after, white space, special char and number not allowed only hyphen.*/
